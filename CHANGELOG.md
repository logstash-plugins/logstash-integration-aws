## 7.3.4
  - timestamp precision mismatch causing S3 input to skip backup and delete operations [#60](https://github.com/logstash-plugins/logstash-integration-aws/pull/60)
